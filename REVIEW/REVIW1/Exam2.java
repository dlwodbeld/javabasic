...
2. 특수문자는 밑줄과 $만 사용할수있다.
3.숫자를 사용할수는 있지만 단 첫번쨰 글자로는 쓸수없다. a1(o) /1a(x)
...
*/
        ...
        }//value2는 안에서 선언했기때문에 밖으로 나오면 사라진다.
        ...
        long value9 = (long)10;
        /*
        형변환은 자바가 자동으로 수행하는 자동 형변환과 개발자가 직접 형 변환을 수행해야하는 수동형변환이 있다.
        크기가 작은 자료형을 큰 자료형에 대입할때는 어떤 손실도 발생하지 않는다.
        따라서 작은 자료형을 큰 자료형에 담으면 개발자가 변환코드를 넣어주지않아도
        자바가 자동으로 타입을 변한해주는데 이것을 업캐스팅이라고한다.

        자바에서 정수형 자료형들과 그 크기를 순서대로
        byte < short < int < long
